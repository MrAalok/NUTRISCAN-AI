...
import { Scan, Heart, Shield, Sparkles } from 'lucide-react';
  ...
  return (
    <footer className="border-t border-white/10 bg-[#060911] pt-12 pb-8 px-4 lg:px-8 text-slate-400 text-xs">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-slate-400 text-xs font-light max-w-sm mb-4 leading-relaxed">
            "Let's make technology the guardian of our health." An AI-powered initiative by Tech for Health (Arushi Shivhare) to bring food transparency to every plate.
          </p>
        ...
        {/* Col 3: Navigation */}
        <div>
          <h4 className="text-xs font-bold text-white uppercase tracking-wider mb-3 font-['Outfit']">Project Details</h4>
          <ul className="space-y-2 text-slate-400">
            <li><span>Presented by: Tech for Health</span></li>
            <li><span>Founder: Arushi Shivhare</span></li>
            <li><span>Project Status: Active</span></li>
            <li><span className="text-emerald-400">AI Engine: Online v2.4</span></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
        <p>© 2026 NutriScan AI • Tech for Health. All rights reserved.</p>
